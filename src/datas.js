export const PrivacyPolicyData = [
  {
    description_1:
      "FORBIT is one of the rising company for software and IOT based services in Bangladesh offer by some young entrepreneurs. As part of our services we built the SultanTracker app as a Free app. This SERVICE is provided by FORBIT at no cost and is intended for use as is.",
    description_2:
  ...
  },
  {
    ...
    description_1:
      "We share your personal information, including name, email, and location with others only within the organization or group used in SultanTracker services.",
    description_2:
  ...
  },
  {
    ...
    description_1:
      "FORBIT collects various types of personal information about you both online and offline, as described in this privacy policy. Under the law of Bangladesh, FORBIT customers who are residents of Bangladesh or we the service of FORBIT, may have to disclose their data or information till the last available or retained data to third parties including government entities according to the law of the land as required. We will comply with such request which will be applicable based on the law of the country.",
  },
